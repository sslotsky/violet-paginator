...
function registerPaginator(_ref) {
  ...
  var _ref$initialSettings = _ref.initialSettings;
  var initialSettings = _ref$initialSettings === undefined ? {} : _ref$initialSettings;
  var _ref$pageParams = _ref.pageParams;
  var pageParams = _ref$pageParams === undefined ? {} : _ref$pageParams;
  var _ref$locator = _ref.locator;
  var locator = _ref$locator === undefined ? defaultLocator(listId) : _ref$locator;
...
function isRemoving(state, itemId) {
