...
function updatingAll(state, action) {
  return (0, _reduxResolver.updateListItem)(state, action.id, function (p) {
    return p.set('bulkUpdating', true);
  });
}

function updateAll(state, action) {
  return (0, _reduxResolver.updateListItem)(state, action.id, function (p) {
    return p.set('bulkUpdateError', null).set('bulkUpdating', false).set('results', p.get('results').map(function (r) {
...
function bulkError(state, action) {
  return (0, _reduxResolver.updateListItem)(state, action.id, function (p) {
    return p.set('bulkUpdateError', action.error).set('bulkUpdating', false);
  });
}
