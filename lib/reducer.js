...
function initialize(state, action) {
  ...
  var _ = action.type,
      _action$filters = action.filters,
      filters = _action$filters === undefined ? {} : _action$filters,
      _action$preloaded = action.preloaded,
      preloaded = _action$preloaded === undefined ? {} : _action$preloaded,
      rest = _objectWithoutProperties(action, ['type', 'filters', 'preloaded']);

  var _preloaded$results = preloaded.results,
      results = _preloaded$results === undefined ? [] : _preloaded$results,
      _preloaded$totalCount = preloaded.totalCount,
      totalCount = _preloaded$totalCount === undefined ? 0 : _preloaded$totalCount,
      _preloaded$page = preloaded.page,
      page = _preloaded$page === undefined ? 1 : _preloaded$page;
