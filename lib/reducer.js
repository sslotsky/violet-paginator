...
function updateItem(state, action) {
  return state.merge({
    results: (0, _reduxResolver.updateListItem)(state.get('results'), action.itemId, function (item) {
...
function resetItem(state, action) {
  return state.merge({
    results: (0, _reduxResolver.updateListItem)(state.get('results'), action.itemId, function () {
