...
function Paginator(props) {
  ...
  var begin = _react2.default.createElement(
    'li',
    { className: (0, _classNames2.default)().withConditional({ current: currentPage === 1 }).load() },
  ...
  var end = totalPages > 1 && _react2.default.createElement(
    'li',
    { className: (0, _classNames2.default)().withConditional({ current: currentPage === totalPages }).load() },
